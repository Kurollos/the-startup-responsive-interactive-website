...
kan ik fouten vinden en is mijn code makkelijker aan te passen en 
kunnen anderen mijn code beter begrijpen en dan word mijn code steeds beter
...
Hier zie je dat alles van de header netjes bij elkaar staat en in logische volgorde, 
zoals in de HTML: <header> → <nav> → <ul> → <li> → <a>.
...
3. Waarom ik deze conventies gebruik

Houdt de CSS overzichtelijk
Verbetert leesbaarheid en onderhoudbaarheid
Voorkomt dat styling per ongeluk overschreven wordt
